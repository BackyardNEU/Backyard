...
## Support Page --> Ben
- Q&A
- Tickets + ticket tracking + autogenerated tickets and ticket IDs
- Bug reports

 ## About the Devs --> Milo + info from evb
 - About devs, description + linkedin, github, persoanl website

## LEGAL ISSUES --> Mehr help + everybody else
- Terms of Service
- Privacy Policy

## Club Discovery --> Connor
...
## Reviews & Ratings --> Put a pin on it until fully ready
...
## This Week (Live Event Calendar) --> Ryan Marshall
...
## Notifications --> Ben + Connor + Milo Design
...
## Club Admin Panel --> Ryan Marshall
...
## Moderation --> Sinha + Ryan Marshall
- Profanity filter on reviews and bios --> Sinha
- AI image scanning (block inappropriate uploads) --> Sinha
...
## Authentication & Security --> Sinha + Connor
...
## Analytics & Insights (Internal) --> Sinha
